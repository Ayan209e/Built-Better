    ...
    <div className='loginContainer'>
      ...
      <ul className="nav nav-tabs">
        <li className="nav-item">
          <a
            className={`crsr nav-link ${activeTab === 'login' ? 'active' : ''}`}
        ...
        <li className="nav-item">
          <a
            className={`crsr nav-link ${activeTab === 'register' ? 'active' : ''}`}
        ...
        {activeTab === 'login' && (
          <div className={`tab-pane fade ${activeTab === 'login' ? 'show active' : ''}`}>
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <button type="submit" className="btn btn-primary yllw" onClick={addTologin}>Submit</button>
            </form>
          </div>
        )}
        ...
        {activeTab === 'register' && (
          <div className={`tab-pane fade ${activeTab === 'register' ? 'show active' : ''}`}>
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <button type="submit" className="btn btn-primary yllw" onClick={addToRegister}>Submit</button>
            </form>
          </div>
        )}
      </div>
